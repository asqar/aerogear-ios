...
/**
 An internal AGAuthenticator module implementation that uses either 'Basic' or 'Digest' as the auth transport.
 ...
 */
@interface AGHttpBasicDigestAuthentication : NSObject <AGAuthenticationModuleAdapter>
